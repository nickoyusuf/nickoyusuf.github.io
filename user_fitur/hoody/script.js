document.getElementById("hitam").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/hitam.png";
}
document.getElementById("putih").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/putih.png";  
}
document.getElementById("abumisty").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/abumisty.png";   
}
document.getElementById("abutua").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/abutua.png";
}
document.getElementById("abumuda").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/abumuda.png";
}
document.getElementById("merah").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/merah.png";
}
document.getElementById("maroon").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/maroon.png";
}
document.getElementById("teracota").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/teracota.png";
}
document.getElementById("pink").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/pink.png";
}
document.getElementById("fanta").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/fanta.png";
}
document.getElementById("navy").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/navy.png";
}
document.getElementById("biruturkis").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/biruturkis.png";
}
document.getElementById("birubenhur").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/birubenhur.png";
}
document.getElementById("birumuda").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/birumuda.png";
}
document.getElementById("hijauarmy").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/hijauarmy.png";
}
document.getElementById("hijaubotol").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/hijaubotol.png";
}
document.getElementById("hijaustabilo").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/hijaustabilo.png";
}
document.getElementById("hijautosca").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/hijautosca.png";
}
document.getElementById("hijaufuji").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/hijaufuji.png";
}
document.getElementById("mustard").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/mustard.png";
}
document.getElementById("kuningkenari").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/kuningkenari.png";
}
document.getElementById("oren").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/oren.png";
}
document.getElementById("ungu").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/ungu.png";
}
document.getElementById("cream").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/cream.png";
}
document.getElementById("coklat").onclick = function(){
	document.getElementById("kaos").src = "hoodydepan/coklat.png";
}
