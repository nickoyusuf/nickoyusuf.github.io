document.getElementById("hitam").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/hitam.png";
}
document.getElementById("putih").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/putih.png";  
}
document.getElementById("abumisty").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/abumisty.png";   
}
document.getElementById("abutua").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/abutua.png";
}
document.getElementById("abumuda").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/abumuda.png";
}
document.getElementById("merah").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/merah.png";
}
document.getElementById("maroon").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/maroon.png";
}
document.getElementById("teracota").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/teracota.png";
}
document.getElementById("pink").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/pink.png";
}
document.getElementById("fanta").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/fanta.png";
}
document.getElementById("navy").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/navy.png";
}
document.getElementById("biruturkis").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/biruturkis.png";
}
document.getElementById("birubenhur").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/birubenhur.png";
}
document.getElementById("birumuda").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/birumuda.png";
}
document.getElementById("hijauarmy").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/hijauarmy.png";
}
document.getElementById("hijaubotol").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/hijaubotol.png";
}
document.getElementById("hijaustabilo").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/hijaustabilo.png";
}
document.getElementById("hijautosca").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/hijautosca.png";
}
document.getElementById("hijaufuji").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/hijaufuji.png";
}
document.getElementById("mustard").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/mustard.png";
}
document.getElementById("kuningkenari").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/kuningkenari.png";
}
document.getElementById("oren").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/oren.png";
}
document.getElementById("ungu").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/ungu.png";
}
document.getElementById("cream").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/cream.png";
}
document.getElementById("coklat").onclick = function(){
	document.getElementById("kaos").src = "lsbelakang/coklat.png";
}
