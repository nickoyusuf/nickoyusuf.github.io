document.getElementById("hitam").onclick = function(){
	document.getElementById("kaos").src = "polodepan/hitam.png";
}
document.getElementById("putih").onclick = function(){
	document.getElementById("kaos").src = "polodepan/putih.png";  
}
document.getElementById("abumisty").onclick = function(){
	document.getElementById("kaos").src = "polodepan/abumisty.png";   
}
document.getElementById("abutua").onclick = function(){
	document.getElementById("kaos").src = "polodepan/abutua.png";
}
document.getElementById("abumuda").onclick = function(){
	document.getElementById("kaos").src = "polodepan/abumuda.png";
}
document.getElementById("merah").onclick = function(){
	document.getElementById("kaos").src = "polodepan/merah.png";
}
document.getElementById("maroon").onclick = function(){
	document.getElementById("kaos").src = "polodepan/maroon.png";
}
document.getElementById("teracota").onclick = function(){
	document.getElementById("kaos").src = "polodepan/teracota.png";
}
document.getElementById("pink").onclick = function(){
	document.getElementById("kaos").src = "polodepan/pink.png";
}
document.getElementById("fanta").onclick = function(){
	document.getElementById("kaos").src = "polodepan/fanta.png";
}
document.getElementById("navy").onclick = function(){
	document.getElementById("kaos").src = "polodepan/navy.png";
}
document.getElementById("biruturkis").onclick = function(){
	document.getElementById("kaos").src = "polodepan/biruturkis.png";
}
document.getElementById("birubenhur").onclick = function(){
	document.getElementById("kaos").src = "polodepan/birubenhur.png";
}
document.getElementById("birumuda").onclick = function(){
	document.getElementById("kaos").src = "polodepan/birumuda.png";
}
document.getElementById("hijauarmy").onclick = function(){
	document.getElementById("kaos").src = "polodepan/hijauarmy.png";
}
document.getElementById("hijaubotol").onclick = function(){
	document.getElementById("kaos").src = "polodepan/hijaubotol.png";
}
document.getElementById("hijaustabilo").onclick = function(){
	document.getElementById("kaos").src = "polodepan/hijaustabilo.png";
}
document.getElementById("hijautosca").onclick = function(){
	document.getElementById("kaos").src = "polodepan/hijautosca.png";
}
document.getElementById("hijaufuji").onclick = function(){
	document.getElementById("kaos").src = "polodepan/hijaufuji.png";
}
document.getElementById("mustard").onclick = function(){
	document.getElementById("kaos").src = "polodepan/mustard.png";
}
document.getElementById("kuningkenari").onclick = function(){
	document.getElementById("kaos").src = "polodepan/kuningkenari.png";
}
document.getElementById("oren").onclick = function(){
	document.getElementById("kaos").src = "polodepan/oren.png";
}
document.getElementById("ungu").onclick = function(){
	document.getElementById("kaos").src = "polodepan/ungu.png";
}
document.getElementById("cream").onclick = function(){
	document.getElementById("kaos").src = "polodepan/cream.png";
}
document.getElementById("coklat").onclick = function(){
	document.getElementById("kaos").src = "polodepan/coklat.png";
}
