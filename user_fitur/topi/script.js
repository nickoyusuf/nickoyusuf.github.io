document.getElementById("hitam").onclick = function(){
	document.getElementById("kaos").src = "topi-img/hitam.png";
}
document.getElementById("putih").onclick = function(){
	document.getElementById("kaos").src = "topi-img/putih.png";  
}
document.getElementById("abumisty").onclick = function(){
	document.getElementById("kaos").src = "topi-img/abumisty.png";   
}
document.getElementById("abutua").onclick = function(){
	document.getElementById("kaos").src = "topi-img/abutua.png";
}
document.getElementById("abumuda").onclick = function(){
	document.getElementById("kaos").src = "topi-img/abumuda.png";
}
document.getElementById("merah").onclick = function(){
	document.getElementById("kaos").src = "topi-img/merah.png";
}
document.getElementById("maroon").onclick = function(){
	document.getElementById("kaos").src = "topi-img/maroon.png";
}
document.getElementById("teracota").onclick = function(){
	document.getElementById("kaos").src = "topi-img/teracota.png";
}
document.getElementById("pink").onclick = function(){
	document.getElementById("kaos").src = "topi-img/pink.png";
}
document.getElementById("fanta").onclick = function(){
	document.getElementById("kaos").src = "topi-img/fanta.png";
}
document.getElementById("navy").onclick = function(){
	document.getElementById("kaos").src = "topi-img/navy.png";
}
document.getElementById("biruturkis").onclick = function(){
	document.getElementById("kaos").src = "topi-img/biruturkis.png";
}
document.getElementById("birubenhur").onclick = function(){
	document.getElementById("kaos").src = "topi-img/birubenhur.png";
}
document.getElementById("birumuda").onclick = function(){
	document.getElementById("kaos").src = "topi-img/birumuda.png";
}
document.getElementById("hijauarmy").onclick = function(){
	document.getElementById("kaos").src = "topi-img/hijauarmy.png";
}
document.getElementById("hijaubotol").onclick = function(){
	document.getElementById("kaos").src = "topi-img/hijaubotol.png";
}
document.getElementById("hijaustabilo").onclick = function(){
	document.getElementById("kaos").src = "topi-img/hijaustabilo.png";
}
document.getElementById("hijautosca").onclick = function(){
	document.getElementById("kaos").src = "topi-img/hijautosca.png";
}
document.getElementById("hijaufuji").onclick = function(){
	document.getElementById("kaos").src = "topi-img/hijaufuji.png";
}
document.getElementById("mustard").onclick = function(){
	document.getElementById("kaos").src = "topi-img/mustard.png";
}
document.getElementById("kuningkenari").onclick = function(){
	document.getElementById("kaos").src = "topi-img/kuningkenari.png";
}
document.getElementById("oren").onclick = function(){
	document.getElementById("kaos").src = "topi-img/oren.png";
}
document.getElementById("ungu").onclick = function(){
	document.getElementById("kaos").src = "topi-img/ungu.png";
}
document.getElementById("cream").onclick = function(){
	document.getElementById("kaos").src = "topi-img/cream.png";
}
document.getElementById("coklat").onclick = function(){
	document.getElementById("kaos").src = "topi-img/coklat.png";
}
